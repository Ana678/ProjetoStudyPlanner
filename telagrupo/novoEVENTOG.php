<?php
	...
	if(isset($_GET['add'])){
		...
		echo "<script> alert('$codigoa'); </script>";
		...
		if(isset($_POST['data'])){
			...
			$consulta = $MySQLi->query("INSERT INTO TB_EVENTOSGRUPOS(EVG_DATA, EVG_TITULO, EVG_DESCRICAO,EVG_GRU_CODIGO) VALUES ('$data','$titulo','$desc',$codigoa)");
...
<form action="?add=<?php echo $codigo ?>" method="POST">	
