...
--
-- Host: localhost:3308
-- Generation Time: 25-Fev-2020 às 11:41
...
(48, '', '2020-02-14 17:22:21', 13, 30),
(49, 'sasa', '2020-02-15 11:27:32', 13, 44);
...
-- Error reading data for table db_projeto.tb_conteudos: #1064 - Você tem um erro de sintaxe no seu SQL próximo a 'FROM `db_projeto`.`tb_conteudos`' na linha 1
...
(8, 5, '2020-02-13', 3, 13),
(9, 1, '2020-02-09', 3, 13),
(10, 6, '2020-02-14', 1, 13),
(11, 6, '2020-02-14', 1, 13),
(12, 6, '2020-02-14', 3, 13);
...
(8, '2020-04-22', 'AULA', 'atividade', 13, '#81F7BE', 2),
(9, '2020-02-01', 'AULA', 'atividade', 13, '#3A01DF', 1),
(14, '2020-02-28', 'APRESENTAÇÃO', 'dia especial', 13, '#400000', 1),
(15, '2020-08-04', 'ANIVERSARIO', 'vai ser show', 13, '#ff8000', 1),
(16, '2020-02-20', 'PROVA', 'Prova de Química', 13, '#ff0000', 1),
(17, '2020-02-28', 'PROJETO', 'entrega final', 13, '#008080', 1);
...
(11, 'oi', '#ff80c0', '2020-02-14 18:01:27'),
(12, 'Olá João, Como vai? Gostaria de saber um pouco mais sobre como inserir citações. Você poderia me ajudar?', '#f7c4da', '2020-02-16 14:16:44'),
(13, 'João, você pode vim no laboratório de redes, por favor?', '#f0cbdb', '2020-02-16 14:42:29'),
(14, 'Quais são mesmo as cores que o professor disse que era pra usar na molécula?', '#e5d6dc', '2020-02-16 14:46:30'),
(15, 'Tenho uma novidade pra te contar', '#c4a9b4', '2020-02-16 14:48:46'),
(16, 'OI', '#000000', '2020-02-25 11:29:21');
...
CREATE TABLE `tb_usuarios` (
  ...
  `USU_NOTIFICACAO` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tb_usuarios` (`USU_CODIGO`, `USU_NOME`, `USU_SOBRENOME`, `USU_SENHA`, `USU_EMAIL`, `USU_ARQUIVO`, `USU_NOTIFICACAO`) VALUES
(7, 'Ana', 'Maria', 'ana', 'ana@hotmail.com', '7.jpg', 0),
(12, 'Erica', 'Maria', '12345', 'erica@hotmail.com', '12.jpg', 0),
(13, 'joao ', 'elias', '123456', 'joao@hotmail.com', '13.jpg', 0),
(14, 'Bento', 'Diniz', '12', 'bentodiniz@hotmail.com', '14.jpg', 0),
(15, 'Augusto', 'Castro', 'guto', 'augusto@hotmail.com', '15.jpg', 0),
(16, 'José', '', '1', 'jose@hotmail.com', '16.jpg', 0),
(17, 'Mercia', '', '10', 'mercia@hotmail.com', '', 0);
...
--
ALTER TABLE `tb_comentarios`
  MODIFY `COM_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `tb_desempenhousuarios`
  MODIFY `DES_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tb_eventosusuarios`
  MODIFY `EVU_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tb_mensagens`
  MODIFY `MEN_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tb_postagens`
--
ALTER TABLE `tb_postagens`
  MODIFY `POS_CODIGO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
